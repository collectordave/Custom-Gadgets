...
tocTab[ir++] = new Array ("1.1", "Welcome", "welcometopic.htm", "", "cicon9.gif", "cicon9.gif");
tocTab[ir++] = new Array ("2", "Usage", "", "", "cicon1.gif", "cicon2.gif");
...
function windowErr() {
isDyn = false;
$hmtoc.location.href = "onoffbuttont_content.htm";
window.onerror = oldOnError;
}
function reDisplay(currentNumber,tocChange,noLink,e) {
if (isIndex && ($hmtoc.location.href.substring($hmtoc.location.href.lastIndexOf("/")+1,$hmtoc.location.href.length) != "onoffbuttont_kwindex.htm")) { isIndex=false; isContent=true; }
...
$hmtoc.location.href = "onoffbuttont_kwindex.htm";
isIndex = true;
}
hasSelection = false;
if (isContent) {
if (!isDyn) {
if ($hmtoc.location.href.substring($hmtoc.location.href.lastIndexOf("/")+1,$hmtoc.location.href.length) != "onoffbuttont_content.htm") $hmtoc.location.href = "onoffbuttont_content.htm";
}
else {
...
if (isContent && isDyn) {
$hmtoc.document.write("\n\r\n\r<hr><font face=\"Arial,Helvetica\" size=\"1\">&copy; 2016 ... Your company</font>\n\r</body>\n\r</html>\n\r");
